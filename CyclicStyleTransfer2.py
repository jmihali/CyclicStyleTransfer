...
while n_iter[0] <= 2 * max_iter:
    ...
    def closure_stylization():
        ...
        try:
            if similarity_type == 'mse':
                loss = sum(layer_losses) + similarity_weight * nn.MSELoss()(content_image,
                                                                            reversed_img)  # added term for similarity loss
    ...
    if n_iter[0] % save_iter == (save_iter - 1):
        ...
        st.save("Images/cst_stylized_image_check%d.jpg" % checkpoint)
